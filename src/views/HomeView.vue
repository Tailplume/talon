  ...
  <section class="min-h-screen bg-slate-900 text-white rainbow-bloom">
    ...
    >
      <img
        ...
        alt="Be yourself"
        class="w-10/12 md:w-9/12 lg:w-7/12 xl:w-5/12 mb-3"
      />
      ...
      <form>
        <div
          name="link"
          class="px-6 py-4 mr-4 bg-white/[.16] rounded-r-2xl border-black/[0.4] border-2 inline text-xl font-light opacity-60"
          style="border-top-left-radius: 2rem; border-bottom-left-radius: 2rem"
        >
          tailplu.me/
          <input type="text" class="bg-transparent w-44" disabled />
        </div>

        <button
          class="bg-white/[.16] px-6 py-4 rounded-full hover:bg-white/[0.25] font-medium duration-200 text-xl disabled:opacity-50 disabled:pointer-events-none relative"
          disabled
        >
